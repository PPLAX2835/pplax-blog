...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb3 COLLATE=utf8_bin COMMENT='config_info';
...
INSERT INTO `config_info` (`id`, `data_id`, `group_id`, `content`, `md5`, `gmt_create`, `gmt_modified`, `src_user`, `src_ip`, `app_name`, `tenant_id`, `c_desc`, `c_use`, `effect`, `type`, `c_schema`, `encrypted_data_key`) VALUES (2,'pplax-config','PPLAX_BLOG','pplax:\r\n  api:\r\n    base-path: /api   # 统一父级请求路径','fea765ef95324d22536718ac855e00d4','2024-01-23 12:54:41','2024-01-23 12:54:41','nacos','192.168.48.1','','712185cc-1239-4192-9cb1-c71d5b242f91','自定义配置',NULL,NULL,'yaml',NULL,'');
...
CREATE TABLE `his_config_info` (
  ...
  KEY `idx_did` (`data_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb3 COLLATE=utf8_bin COMMENT='多租户改造';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-01-23 14:38:42
