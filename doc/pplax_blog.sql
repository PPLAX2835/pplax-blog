...
CREATE TABLE `t_chat_room` (
  `uid` varchar(32) NOT NULL COMMENT '唯一uid',
  `member1_uid` varchar(32) DEFAULT NULL COMMENT '成员1uid，用于私聊',
  `member2_uid` varchar(32) DEFAULT NULL COMMENT '成员2uid，用于私聊',
  `type` int NOT NULL COMMENT '类型 0公共 1私聊',
  `status` tinyint unsigned NOT NULL DEFAULT '1' COMMENT '状态',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`uid`)
...
INSERT INTO `t_chat_room` (`uid`, `member1_uid`, `member2_uid`, `type`, `status`, `create_time`, `update_time`) VALUES ('0e6c7d76b94c49eab3ce42b52b23693a',NULL,NULL,0,1,'2024-04-11 11:17:30','2024-04-11 11:31:25'),('3afc33f04e9341fcbedfb24b3a6d971d','f8616ce5aa0c8eeacfa0d997dbdbe0d3','a2fc23c7668a4b6386b75584d72498a5',1,1,'2024-04-11 11:17:59','2024-04-11 11:31:25');
...
INSERT INTO `t_leave_message` (`uid`, `user_uid`, `content`, `ip`, `address`, `status`, `create_time`, `update_time`) VALUES ('89f66d021184489a9b6e99244897b897','d288eec502414298a62298aba33a0441','这是一条登录用户留言','127.0.0.1','未知',1,'2024-04-11 09:36:41','2024-04-11 09:41:57'),('cf351892868d4ae38c86cc3a24481a80',NULL,'这是一条游客留言','127.0.0.1','未知',1,'2024-04-11 09:36:22','2024-04-11 09:41:57');
...
INSERT INTO `t_link` (`uid`, `title`, `summary`, `url`, `icon_image_uid`, `click_count`, `create_time`, `update_time`, `status`) VALUES ('96e7367b61dbfbc15c18e77a04443f90','pplax','不知道','pplax.xyz','12bbdc24dc2fd06f7e51749142fef89a',0,'2024-04-11 08:17:17','2024-04-11 08:17:17',12),('bb418e0a9d27490bb71972bd8da5afa6','拾壹博客','','https://www.shiyit.com/','880dd0399aa4e53e205d7f8022f0402c',1,'2024-04-11 08:15:13','2024-04-11 08:15:13',1),('dcc01149be71492dabd55821c22f6061','Mybatis-plus','MyBatis-Plus 为简化开发而生','http://mp.baomidou.com/','eae0417ea3851a2dd482dc65dfa03f11',1,'2024-03-23 07:32:26','2024-03-23 07:32:26',4);
...
-- Dump completed on 2024-04-11 20:21:52
