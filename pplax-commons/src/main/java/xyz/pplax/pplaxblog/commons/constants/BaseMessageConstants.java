...
public class BaseMessageConstants {
    ...
    public static final String EMAIL_UNACTIVATED = "邮箱未激活";
    public static final String MOBILE_UNACTIVATED = "手机未激活";
    ...
    public final static String EXPIRED_TOKEN = "token令牌已过期";
