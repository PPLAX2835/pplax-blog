...
public class MinioUtils {
     ...
     * @param response   请求响应
     */
    public void downloadFile(String bucketName, String originalName,
     ...
     **/
    public String getPreviewUrl(String bucketName, String object, String contentType, Integer validTime, TimeUnit timeUnit) {
     ...
     * @param httpUrl 文件地址
     **/
    public void netToMinio(String httpUrl, String bucketName) {
