...
public class UserFileService extends FileService {
    ...
    public ResponseResult avatarUpload(String mode, String userUid, MultipartFile file) throws Exception {
        ...
        return upload(mode, userUid, "/avatar/", convertToMultipartFile);
    }
     ...
     * @throws Exception
     */
    public ResponseResult spaceBackgroundPictureUpload(String mode, String userUid, MultipartFile file) throws Exception {
        ...
        return upload(mode, userUid, "/spaceBackgroundPicture/", file);
    }
