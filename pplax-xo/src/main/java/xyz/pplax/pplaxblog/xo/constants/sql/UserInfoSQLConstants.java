...
public class UserInfoSQLConstants {
    ...
    public final static String AVATAR_PICTURE_UID = "t_user_info.avatar_picture_uid";
    public final static String SPACE_BACKGROUND_PICTURE_UID = "t_user_info.space_background_picture_uid";
    public final static String BIRTHDAY = "t_user_info.birthday";
    public final static String SUMMARY = "t_user_info.summary";
}
