    ...
    <el-collapse v-model="activeNames" >
      ...
      <el-collapse-item  name="2" class="collapse-class">
        ...
        <table class = "table-class parm-table-class">
          <tr>
            <td style="width:10px"><el-checkbox v-model="checkAll"  @change="handleCheckAllChange"></el-checkbox></td>
          ...
          <tr v-for="(key,index) in tree.parameters">
            <td > <el-checkbox checked v-model="key.checked"></el-checkbox></td>
      ...
      <el-collapse-item  name="abc" class="collapse-class">
        ...
        <json-viewer :value="resData"></json-viewer>
      </el-collapse-item>
    </el-collapse>
  </div>
</template>
...
import { apiTest } from "../../api/swagger";
...
export default {
  ...
  methods : {
    ...
    getSendParam(){
      ...
      apiTest({
        url : '/' + this.routeName.split('-')[0] + url,
        data : sendParm,
        method: v_this.tree.sendWay.toLowerCase()
      }).then(res => {
