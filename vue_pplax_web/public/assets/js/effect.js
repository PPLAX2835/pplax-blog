var stop, staticx; var img = new Image(); img.src = "http://www.pplax.xyz:4390/api/web/style/theme/specialEffects"; function Sakura(x, y, s, r, fn) { this.x = x; this.y = y; this.s = s; this.r = r; this.fn = fn; }
