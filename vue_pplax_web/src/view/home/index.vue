    ...
    <div class="main">
          ...
          <el-carousel class="banner" :interval="5000" arrow="always">
            <el-carousel-item v-for="(item, index) in bannerList" :key="index">
              <router-link class="hand-style" :to="'/blog/' + item.uid">
                <img
                    class="bannerImg"
                    v-lazy="item.coverImage ? item.coverImage.fileUrl : getWebSiteInfoValue('defaultBlogCoverImage')"
                    :key="item.uid"
                />
      ...
      <div class="hot_category">
        <el-tabs v-model="activeName" @tab-click="handleTabClick">
          <el-tab-pane
              class="categoryItem"
              v-for="(item, index) in blogSortList"
              :name="index + ''"
              :key="index"
          >
            <span slot="label">
      ...
      <div class="content">
        ...
        <div style="width: 100%">
          <div class="articleBox" v-if="blogList.length > 0">
            <el-card
                class="articleItem box-shadow-top"
              ...
              <div class="articleInfo">
                <div class="articleInfo-item">
                  <div>
                    ...
                    <span v-if="item.status === statusList.STICK" class="top"
                    >置顶</span
                    >
                ...
                <div class="tag">
                  ...
                  >
                    <el-tag
                        ...
                        size="mini"
                        class="hand-style"
                        @click="handleClike(tag.uid, '/tags')"
                    >
