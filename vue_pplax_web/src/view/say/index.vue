<template>
  <div class="say-main container">
    <div class="say-containner">
      <div class="cover">
        <img :src="getWebSiteInfoValue('sayPageBackground')" alt="" />
          ...
          <div class="rigthBox">
            ...
            <div class="bottomBox">
              ...
              <div class="operate" ref="operate">
                <span
                    class="like hand-style"
                    v-if="!item.isLike"
                    @click="sayLike(item)"
                >
                  <i class="iconfont icon-dianzan"></i> 赞
                </span>
                <span class="like hand-style" v-else @click="canLike(item)">
                  <i class="iconfont icon-quxiaodianzan"></i> 取消
                </span>
                <span class="fgx"></span>
                <span
                    class="commentBtn hand-style"
                    @click="handleShowCommentBox(null, item.uid, index)"
                >
                  <i class="el-icon-chat-dot-square"></i> 评论
                </span>
              </div>
              <a
                  class="operateBtn hand-style"
                  @click="handleShowOperate(index)"
              >
            ...
            <div class="interaction">
              <div
                  v-if="item.likeList && item.likeList.length"
              ...
              >
                <span v-for="like in item.likeList" :key="like.uid">
                  ...
                  {{ like.commentator.userInfo.nickname }}
                ...
                >
                  <div>
                    ...
                    <span v-else>
                      <span
                          class="username"
                      >{{ comment.commentator.userInfo.nickname }}</span
                      >
                      回复
                      <span class="username"
                      >{{ comment.targetUser.userInfo.nickname }}：</span
                      >
                    </span>
                    <span
                        class="content point"
